...
echo -e "     ${CYAN}sudo python3 vhost_manager.py create yourdomain.com 8080${NC}"
echo ""
...
echo -e "  • View certificates: ${CYAN}sudo certbot certificates${NC}"
echo -e "  • Renew certificates: ${CYAN}sudo certbot renew${NC}"
echo -e "  • Test renewal: ${CYAN}sudo certbot renew --dry-run${NC}"
echo -e "  • Apache status: ${CYAN}sudo systemctl status apache2${NC}"
echo ""
print_header "📖 Documentation:"
echo -e "  GitHub: ${CYAN}https://github.com/Noubissie237/reverse-proxy${NC}"
echo ""